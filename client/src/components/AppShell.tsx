...
import React, { createRef, RefObject, Suspense, useRef, useState } from "react";
...
function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <div className="flex flex-row h-screen justify-start overflow-hidden">
        ...
        <div className="w-full flex flex-col items-end overflow-scroll h-screen no-scrollbar" ref={globalScrollRef} onScroll={handleScroll}>
